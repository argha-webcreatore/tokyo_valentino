...
class Boilerplate extends BaseConfig
{
    ...
    public $home = [
        'namespace'  => 'agungsugiarto\boilerplate\Controllers',
        'banneImageController' => 'Home::banner_images',
        'storeController' => 'Home::stores',
        'filter'=> 'permission:home-permission',
    ];
    ...
    public $theme = [
        ...
        'sidebar' => [
            ...
            'brand' => [
                ...
                'logo' => [
                    ...
                    'text'   => '<strong>Tokyo Valentino</strong>',
                    'shadow' => 2,
                ],
            ],
            'user' => [
        ...
        'footer' => [
            'fixed'      => false,
            'vendorname' => 'WebCreatore Digital Solutions',
            'vendorlink' => '#',
        ],
    ];
}
