...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/home/stores/add') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <?= csrf_field() ?>
                    <div class="form-group">
                        <label for="inputName" class="col-form-label">Store name</label>
                        <div class="">
                            <div class="input-group">
                                <input type="text" name="store_name" value="<?= old('store_name') ?>" class="form-control <?= session('error.store_name') ? 'is-invalid' : '' ?>" placeholder="Store name" autocomplete="off">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-group">
                                <input type="text" name="store_address" value="<?= old('store_address') ?>" class="form-control <?= session('error.store_address') ? 'is-invalid' : '' ?>" placeholder="Store address" autocomplete="off">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-group">
                                <input type="number" name="store_contact" value="<?= old('store_contact') ?>" class="form-control <?= session('error.store_contact') ? 'is-invalid' : '' ?>" placeholder="Store contact" autocomplete="off">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-group">
                                <textarea name="store_description" class="form-control <?= session('error.store_description') ? 'is-invalid' : '' ?>" placeholder="Store Description" autocomplete="off"><?= old('store_description') ?></textarea>
                            </div>
