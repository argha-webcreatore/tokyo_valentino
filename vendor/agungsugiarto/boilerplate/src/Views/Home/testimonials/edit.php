...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/home/testimonials/edit/'.$testimonial['id']) ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <?= csrf_field() ?>
                    <div class="form-group">
                        <label for="inputName" class="col-form-label">Name</label>
                        <div class="">
                            <div class="input-group">
                                <input type="text" name="name" value="<?= $testimonial['name'] ?>" class="form-control <?= session('error.name') ? 'is-invalid' : '' ?>" placeholder="Name" autocomplete="off">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-group">
                                <input type="text" name="location" value="<?= $testimonial['location'] ?>" class="form-control <?= session('error.location') ? 'is-invalid' : '' ?>" placeholder="Location" autocomplete="off">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <div class="input-group">
                                <textarea type="number" name="description" class="form-control <?= session('error.description') ? 'is-invalid' : '' ?>" placeholder="Description" autocomplete="off"><?= $testimonial['description'] ?></textarea>
                            </div>
