  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 class="text-center">Are you sure want to delete this testimonial ?</h4>
...
<div class="card card-default">
    <div class="card-header">
        <div class="card-tools">
            <div class="btn-group">
                <a href="<?= base_url('admin/home/testimonials/add') ?>" class="btn btn-sm btn-block btn-primary"><i class="fa fa-plus"></i>
                    Add testimonials
                </a>
            </div>
        </div>
...
<script>
    var table = $('#table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?=base_url('admin/home/testimonials/list')?>",
        "order": [
            [4, 'desc']
        ],
        "columnDefs": [{
    ...
    $('.btn_delete').click(function(){
        var id = $(this).attr('id');
        $.ajax({
            url : "<?= base_url('admin/home/testimonials/delete');?>",
            type : "post",
