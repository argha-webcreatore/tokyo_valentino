    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/menu') ?>" method="post" class="form-horizontal">
                        <?= csrf_field() ?>
...
$(function () {
    ...
    $(document).on('click', '#btn-edit', function(e) {
        ...
        $.ajax({
            url: `<?= base_url('admin/menu') ?>/${$(this).attr('data-id')}/edit`,
            method: 'GET',
            dataType: 'JSON',
    ...
    $(document).on('click', '#btn-update', function(e) {
        ...
        $.ajax({
            url: `<?= base_url('admin/menu') ?>/${ $('#menu_id').val() }`,
            method: 'PUT',
    ...
    $(document).on('click', '#btn-delete', function(e) {
        ...
        .then((result) => {
            if (result.value) {
                $.ajax({
                    url: `<?= base_url('admin/menu') ?>/${$(this).attr('data-id')}`,
                    method: 'DELETE',
                }).done((data, textStatus, jqXHR) => {
                    Toast.fire({
                        icon: 'success',
