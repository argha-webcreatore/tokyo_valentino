...
<script>
    ...
    $(document).on('click', '.btn-edit', function(e) {
        e.preventDefault();
        $.ajax({
            url: `<?= base_url('admin/permission') ?>/${$(this).attr('data-id')}/edit`,
            method: 'GET',
    ...
    $(document).on('click', '#btn-update-permission', function(e) {
        ...
        $.ajax({
            url: `<?= base_url('admin/permission') ?>/${ $('#permission_id').val() }`,
            method: 'PUT',
    ...
    $(document).on('click', '.btn-delete', function(e) {
        ...
        .then((result) => {
            if (result.value) {
                $.ajax({
                    url: `<?= base_url('admin/permission') ?>/${$(this).attr('data-id')}`,
                    method: 'DELETE',
                }).done((data, textStatus, jqXHR) => {
                    Toast.fire({
                        icon: 'success',
