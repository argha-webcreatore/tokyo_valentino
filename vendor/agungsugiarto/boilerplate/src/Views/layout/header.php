<nav
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a href="<?= base_url('admin/user/profile') ?>" class="nav-link d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="<?= base_url('admin/logout') ?>">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <a href="<?= base_url('admin/logout') ?>" class="btn btn-primary btn-block"><b><?= lang('boilerplate.global.logout') ?></b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
            </div>
